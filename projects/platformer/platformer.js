$(function () {
  ...
  function setup() {
    ...
    createPlatform(35,300,200,20)
    createPlatform(400,400,200,20)
    createPlatform(300,530,100,20)
    ...
    createCollectable("database", 500,30);
    createCollectable("database", 300, 50)
    createCollectable("database", 700, 80)
